...
/// A signal type that indicates that the future state has completed the promise by invoking the
/// future's handler with either an error or a value
...
struct future_state_impl {
    ...
    explicit future_state_impl() : invoker_(), var_(), mutex_() {}
